import { findMaxAverage } from '../0644-maximum-average-subarray-ii.js';

describe('0644-maximum-average-subarray-ii', () => {
  it("findMaxAverage([1, 12, -5, -6, 50, 3], 4)", () => {
    const result = findMaxAverage([1, 12, -5, -6, 50, 3], 4);
    expect(result).toEqual(12.749995231628418);
  });
  ...
  it("findMaxAverage([0, 4, 0, 3, 2], 1)", () => {
    ...
    expect(result).toEqual(3.9999923706054688);
  });
