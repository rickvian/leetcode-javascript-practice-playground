...
describe("0424-longest-repeating-character-replacement", () => {
  ...
  // Tricky: best window is BABBBBB (positions 3–9, replace the lone A) → 7 B's, not the shorter A-prefix run
  it("should return 7 for AAABABBBBBAB with k=1", () => {
    expect(characterReplacement("AAABABBBBBAB", 1)).toBe(7);
  });
});
