 ...
 * - Traverse backward accumulating citationBiggerSoFar:
 *   - h=5: citationBiggerSoFar = 0, count[5] = 2 → 0+2=2 >= 5? No
 *   - h=4: citationBiggerSoFar = 2, count[4] = 0 → 2+0=2 >= 4? No
 *   - h=3: citationBiggerSoFar = 2, count[3] = 1 → 2+1=3 >= 3? Yes, return 3
 *
